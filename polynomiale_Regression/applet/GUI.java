...
public class GUI extends Applet {
    ...
    public void paint(Graphics g) {
        ...
        if (change) {
            ...
            buffer.drawLine(0, getHeight() - 99,
                            getWidth(), getHeight() - 99);
            buffer.drawLine(0, getHeight() - 100,
                            getWidth(), getHeight() - 100);
            buffer.drawLine(0, getHeight() - 101,
                            getWidth(), getHeight() - 101);

            //Gitterlinien zeichnen
            for (int i = 0; i < getHeight(); i += 100)
                buffer.drawLine(0, getHeight() - i,
        ...
        if (change) {
            ...
            buffer.drawLine(0, (int) n,
                            getWidth(), (int) (getWidth() * m + n));
            buffer.drawLine(0, (int) (n + 1.0),
                            getWidth(), (int) (getWidth() * m + n + 1.0));
            buffer.drawLine(0, (int) (n + 2.0),
                            getWidth(), (int) (getWidth() * m + n + 2.0));
            buffer.drawLine(0, (int) (n - 1.0),
                            getWidth(), (int) (getWidth() * m + n - 1.0));
            buffer.drawLine(0, (int) (n - 2.0),
                            getWidth(), (int) (getWidth() * m + n - 2.0));
